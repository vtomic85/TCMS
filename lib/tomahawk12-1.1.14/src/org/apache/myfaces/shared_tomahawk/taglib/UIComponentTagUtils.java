...
public class UIComponentTagUtils
{
                                        ...
                                        String value)
    {
        if (value != null)
        {
            ...
            {
                ValueBinding vb = context.getApplication().createValueBinding(value);
                component.setValueBinding(org.apache.myfaces.shared_tomahawk.renderkit.JSFAttr.VALUE_ATTR, vb);
            }
                                        ...
                                        String value)
    {
        if (value != null)
        {
            if (component instanceof ValueHolder)
            {
                ...
                {
                    ValueBinding vb = context.getApplication().createValueBinding(value);
                    component.setValueBinding(org.apache.myfaces.shared_tomahawk.renderkit.JSFAttr.CONVERTER_ATTR, vb);
                }
                else
                {

 ...
 * @version $Revision: 1307198 $ $Date: 2012-03-29 20:12:31 -0500 (Thu, 29 Mar 2012) $
 */
public class HtmlTableRendererBase extends HtmlRenderer
{
    ...
    protected void startTable(FacesContext facesContext, UIComponent uiComponent) throws IOException
    {
        ...
        HtmlRendererUtils.renderHTMLAttributes(writer, uiComponent, org.apache.myfaces.shared_tomahawk.renderkit.html.HTML.TABLE_PASSTHROUGH_ATTRIBUTES);
    }
    ...
    protected static String getHeaderClass(UIComponent component)
    {
        ...
        {
            return (String) component.getAttributes().get(org.apache.myfaces.shared_tomahawk.renderkit.JSFAttr.HEADER_CLASS_ATTR);
        }
    }
    ...
    protected static String getFooterClass(UIComponent component)
    {
        ...
        {
            return (String) component.getAttributes().get(org.apache.myfaces.shared_tomahawk.renderkit.JSFAttr.FOOTER_CLASS_ATTR);
        }
    }

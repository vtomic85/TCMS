...
INSERT INTO `cms_element` VALUES (1,'Horoskop za jun: Očekuju vas velike promene','news/view.xhtml?id=1&amp;holderId=0','../news/newsForm.xhtml?newsId=1',1,0,'news',8),(2,'Neredi na tribinama pre derbija','news/view.xhtml?id=2&amp;holderId=7','../news/newsForm.xhtml?newsId=2',2,7,'news',8),(3,'Anketa: Buš popularniji od Obame','news/view.xhtml?id=3&amp;holderId=5','../news/newsForm.xhtml?newsId=3',3,5,'news',8),(4,'“Balkanski špijun” u Zvezdara teatru na japanskom','event/view.xhtml?id=2&amp;holderId=11','../event/eventForm.xhtml?eventId=2',2,11,'event',9),(5,'Gudački kvartet Beogradske filharmonije u Parizu','event/view.xhtml?id=3&amp;holderId=10','../event/eventForm.xhtml?eventId=3',3,10,'event',9),(6,'Prva strana','page/view.xhtml?id=1&amp;holderId=0','../page/pageForm.xhtml?pageId=1',1,0,'page',7),(11,'Iz Pariza: Poslednji Novakov trening pred Rafu','page/view.xhtml?id=2&amp;holderId=13','../page/pageForm.xhtml?pageId=2',2,13,'page',7),(12,'Anketa: Buš popularniji od Obame','news/view.xhtml?id=3&amp;holderId=5','../news/newsForm.xhtml?newsId=3',3,5,'news',8);
...
INSERT INTO `comment` VALUES (1,8,2,0,'Anonymous','Prvi komentar na vest o derbiju od anonimnog člana.','2015-06-02',1,0,0),(2,8,2,1,'admin','Drugi komentar, od administratora.\r\nMalo specijalnih karaktera: !\"#$%&/()=?*\'+\r\n;delete from comment;','2015-06-02',1,0,0),(3,8,2,1,'admin','Testiram SQL injection zaštitu\";delete from comment;','2015-06-02',1,0,0),(4,20,3,0,'Anonymous','Lepa priča','2015-06-03',1,1,0),(5,20,3,0,'Anonymous','Drugi pokušaj ostavljanja komentara','2015-06-03',1,2,1),(6,20,3,0,'Anonymous','Treći pokušaj ostavljanja komentara','2015-06-03',1,0,1);
...
INSERT INTO `contact` VALUES (1,'Šumadijska 28','11550','Lazarevac','+381 11 8125444','+381 64 6124820','','vladimir.tomic.la@gmail.com','www.vladimirtomic.co.nf','https://twitter.com/vtomic85','www.facebook.com/vladimir.tomic.la','rs.linkedin.com/in/vladimirtomic','','');
...
INSERT INTO `region` VALUES (1,'Left 50%',1,50,0),(2,'Right 50%',2,50,1),(3,'Bottom 100%',3,100,0);
...
INSERT INTO `region_part` VALUES (1,1,123,4,'Najnoviji događaji',0),(2,2,124,4,'Najnovije vesti',0),(3,3,75,3,'POGLEDAJTE!!!',0);
...
-- Dump completed on 2015-06-05  9:25:33
